  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form class="insert_form" id="insert_form" action="create-copy.php" method="post" enctype="multipart/form-data">
          <div class="card-body">
           ...
           <div class="card card-primary card-outline">
             ...
             <div class="input-field">
               <table class="table table-bordered" id="table_field">
                  ...
                  <tr>
                    <input class="form-control" type="hidden" size="2"name="anime_id[]">
                    <input class="form-control" type="hidden" size="45"name="episode_name[]">
...
<script>
  ...
  $(document).ready(function(){
    $(document).on('click','.add',function(){
      var html = '';
      html += '<tr>';
      html += '<input class="form-control" type="hidden" size="2"name="anime_id[]" value="';
      html += '<?php echo $_GET['anime_id'] ?>';
      html += '"><input class="form-control" type="hidden" size="45"name="episode_name[]" value="';
      html += '<?php echo $_GET['episode_name'] ?>';
      html += '"><td><input class="form-control" type="text" size="2" name="part[]" required></td>';
      html += '<td><input class="form-control" type="text" size="45" name="linkplayer[]" required></td>';
